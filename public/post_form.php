                ...
                <div class="post-board board-base">
                    ...
                    <form enctype="multipart/form-data" action="./post.php" method="POST">
                        ...
                        <?php if(isset($err["title_emp"])) : ?>
                            <p class="err-message post-error"><?= $err["title_emp"]; ?></p>
                        <?php endif; ?>
                        <?php if(isset($err["title_len"])) : ?>
                            <p class="err-message post-error"><?= $err["title_len"]; ?></p>
                        <?php endif; ?>
                        <?php if(isset($err["message_emp"])) : ?>
                            <p class="err-message post-error"><?= $err["message_emp"]; ?></p>
                        <?php endif; ?>
                        <?php if(isset($err["message_len"])) : ?>
                            <p class="err-message post-error"><?= $err["message_len"]; ?></p>
                        <?php endif; ?>
                        <!-- TITLE -->
                        ...
                        <?php if(isset($err["file_size"])) : ?>
                            <p class="err-message post-error"><?= $err["file_size"]; ?></p>
                        <?php endif; ?>
                        <?php if(isset($err["file_ext"])) : ?>
                            <p class="err-message post-error"><?= $err["file_ext"]; ?></p>
                        <?php endif; ?>
                        <?php if(isset($err["file_quantity"])) : ?>
                            <p class="err-message post-error"><?= $err["file_quantity"]; ?></p>
                        <?php endif; ?>
                        <!-- FILE SELECT -->
